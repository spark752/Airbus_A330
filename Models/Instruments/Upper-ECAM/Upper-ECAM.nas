...
setlistener("sim/signals/fdm-initialized", func {
	...
	upperECAM_ge = canvas_upperECAM_ge.new(group_ge, "Aircraft/Airbus_A330/Models/Instruments/Upper-ECAM/res/ge.svg");
	upperECAM_pwrr = canvas_upperECAM_pwrr.new(group_pwrr, "Aircraft/Airbus_A330/Models/Instruments/Upper-ECAM/res/pwrr.svg");
	upperECAM_test = canvas_upperECAM_test.new(group_test, "Aircraft/Airbus_A330/Models/Instruments/Common/res/du-test.svg");
